...
/*   Updated: 2024/09/02 13:20:44 by rihoy            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Cat::Cat(const Cat &value)
{
	...
	std::cout << "act Brain : " << &value.brain << " content : " << value.brain->getIdea(1) <<std::endl;
	std::cout << "new Brain : " << &this->brain << " content : " << this->getIdea(1) << std::endl;
}
